          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <span className="font-medium text-gray-900 dark:text-white">Clerk Authentication</span>
                  <p className="text-sm text-gray-500">Secure user management</p>
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3 mt-1">✓</span>
                <div>
                  ...
                  <p className="text-sm text-gray-500">Real-time data storage</p>
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3 mt-1">✓</span>
                <div>
                  ...
                  <p className="text-sm text-gray-500">Modern React framework</p>
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3 mt-1">✓</span>
